...
namespace MVCDemo.Controllers
{
    public class PizzasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Size,IsGlutenFree,Price,sauce,topping")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Size,IsGlutenFree,Price,sauce,topping")] Pizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
